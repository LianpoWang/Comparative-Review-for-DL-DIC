...
class DICTr(nn.Module):
    def __init__(self,
        ...
        self.upsampler = nn.Sequential(nn.Conv2d(2 + feature_channels, 480, 3, 1, 1),
                                       nn.ReLU(inplace=True),
                                       nn.Conv2d(480, upsample_factor ** 2 * 9, 1, 1, 0))
    ...
    def forward(self, img0, img1,
        ...
        '''print(f"attn_splits_list: {attn_splits_list}")
        print(f"corr_radius_list: {corr_radius_list}")
        print(f"prop_radius_list: {prop_radius_list}")
