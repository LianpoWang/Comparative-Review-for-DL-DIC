...
class dicDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        sample = {'Ref':Ref_img, 'Def': Def_img}
        if self.transform:
...
class Augmentation(object):
    ...
    def __call__(self, sample):
        if  self.is_Aug:
            ...
            Ref, Def, Ref_croped, Def_croped, start = self.NoAugmentation(sample)
...
def main():
    ...
    #
    train_data = dicDataset(csv_file="/home/dell/DATA/wh/DATASET/Train_annotations10_30_50.csv", root_dir="/home/dell/DATA/wh/DATASET/Train50/", transform=transform)

    train_loader = DataLoader(train_data, batch_size=1, num_workers=0, pin_memory=True, shuffle=True)
